...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.RecommendedViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecommendedViewHolder holder, final int position) {
        final Recommended recomend = recommendedList.get(position);
        holder.recommendedName.setText(recomend.getName());
        holder.recommendedRating.setText(recomend.getRating());
        holder.recommendedPrice.setText("RM "+recomend.getPrice());
        Glide.with(context).load(recomend.getImageUrl()).into(holder.recommendedImage);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("rate", recommendedList.get(position).getRating());
    ...
    public static class RecommendedViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView recommendedName, recommendedRating,recommendedPrice;
